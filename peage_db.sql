...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 21, 2026 at 05:57 PM
...
CREATE TABLE IF NOT EXISTS `paiement` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_paiement_categorie` (`categorie_vehicule_id`),
  KEY `fk_paiement_type` (`type_paiement_id`),
  KEY `fk_paiement_guichet` (`guichet_id`),
  KEY `fk_paiement_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
